...
/**
 * Official shadcn/ui New York v4 Native Select family, copied from
 * https://ui.shadcn.com/r/styles/new-york-v4/native-select.json
 * (same source as apps/v4/registry/new-york-v4/ui/native-select.tsx).
 *
...
export {
  ...
  NativeSelectOption,
  NativeSelect as OfficialNativeSelect,
  NativeSelectOptGroup as OfficialNativeSelectOptGroup,
  NativeSelectOption as OfficialNativeSelectOption,
};
